...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('repo_repository', 'slug', self.gf('django.db.models.fields.SlugField')(default='asdf', max_length=255, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Repository.slug'
        db.delete_column('repo_repository', 'slug')
    ...
    models = {
        ...
        'repo.repository': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'asdf'", 'max_length': '255', 'db_index': 'True'}),
